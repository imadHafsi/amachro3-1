<template>
  <v-card>
    <v-card-title primary-title class="grey lighten-4">
      <!-- <h3 class="headline mb-0">{{ $t('Crud') }}</h3> -->
      <h3 class="headline mb-0">CRUD</h3>
    </v-card-title>
    <v-divider></v-divider>
    <v-card-text>
          ...
          <v-card-title>
            ...
            @click="dialog=true">New Item</v-btn>
            <v-spacer></v-spacer>
            <v-text-field
              append-icon="search"
              label="Search"
          ...
          >
            <template slot="items" slot-scope="props">
              ...
              <td class="justify-center">{{ props.item.calories }}</td>
              <td class="justify-center">{{ props.item.fat }}</td>
              <td class="justify-center">{{ props.item.carbs }}</td>
              <td class="justify-center">{{ props.item.protein }}</td>
